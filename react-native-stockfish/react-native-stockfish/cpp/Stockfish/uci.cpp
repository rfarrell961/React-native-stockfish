...
void (*UCIEngine::sendResponse)(std::string) = nullptr;
...
void UCIEngine::write(std::string cmd) {
    ...
    {
        UCIEngine::sendResponse("readyok");
    }
    ...
    // These commands must not be used during a search!
        ...
        UCIEngine::sendResponse(engine.visualize());
    else if (token == "eval")
        engine.trace_eval();
    else if (token == "compiler")
        UCIEngine::sendResponse(compiler_info());
